                ...
                <Card className="border-white/10 bg-card/90 shadow-2xl relative overflow-hidden">
                    ...
                    <CardHeader className="space-y-4 text-center pb-8">
                        ...
                        <div className="space-y-2">
                            <CardTitle className="text-3xl font-black tracking-tight">Identity Vault</CardTitle>
                            <CardDescription className="text-base">
                                Securely decrypt your DevKeep workspace
                            </CardDescription>
                        </div>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <Button type="submit" variant="premium" className="w-full h-12 text-base rounded-xl mt-2" disabled={isLoading}>
                    ...
                    <CardFooter className="flex flex-col space-y-4 pb-8">
                        <div className="text-sm text-center">
                            <span className="text-white/60">New operator?</span>{" "}
                            <Link href="/signup" className="text-primary hover:text-white font-bold transition-all ml-1 underline underline-offset-4">
                                Request Entry
                            </Link>
                        </div>
                    </CardFooter>
