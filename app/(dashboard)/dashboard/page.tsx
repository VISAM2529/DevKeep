                ...
                <Card className="lg:col-span-2">
                    <CardHeader className="flex flex-row items-center justify-between">
                        <div>
                            ...
                            <CardDescription>Your latest workspace actions</CardDescription>
                        </div>
                    </CardHeader>
                    <CardContent>
                                    ...
                                    <div key={i} className="flex items-center justify-between p-3 rounded-lg hover:bg-white/5 transition-colors group">
                                        <div className="flex items-center gap-3">
                                            <div className="h-8 w-8 rounded-md bg-white/5 flex items-center justify-center border border-white/5">
                                                {item.type === "Project" && <FolderKanban className="h-4 w-4 text-white/70" />}
                                                {item.type === "Credential" && <Lock className="h-4 w-4 text-white/70" />}
                                                {item.type === "Command" && <Terminal className="h-4 w-4 text-white/70" />}
                                                {item.type === "Note" && <FileText className="h-4 w-4 text-white/70" />}
                                            </div>
                                            <div>
                    ...
                    <CardContent className="space-y-3">
                        {[
                            ...
                            <Link key={i} href={tool.href}>
                                <div className="flex items-center justify-between p-3 rounded-lg border border-white/5 hover:bg-white/5 hover:border-white/10 transition-all cursor-pointer group">
                                    <div className="flex items-center gap-3">
                                        <div className="h-8 w-8 rounded-md bg-white/5 flex items-center justify-center group-hover:bg-white/10 transition-colors">
                                            <tool.icon className="h-4 w-4 text-white/70" />
                                        </div>
                                        <span className="text-sm font-medium text-white/80 group-hover:text-white">{tool.label}</span>
                                    </div>
